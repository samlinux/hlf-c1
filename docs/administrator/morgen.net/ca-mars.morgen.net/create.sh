...
fabric-ca-client register -d --id.name user1-mars.morgen.net --id.secret marsUserPW --id.type client -u https://0.0.0.0:7054

## for abac chaincode
fabric-ca-client register -d --id.affiliation org1.department1 --id.name user2-mars.morgen.net --id.secret marsUserPW --id.type client -u https://0.0.0.0:7054
